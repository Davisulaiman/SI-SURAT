        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<span id="alamat">Jl. WR. Supratman, Kandang Limun, Kec. Muara Bangka Hulu, Telp/Fax (0736)32213, Bengkulu 38371</span>';
            ...
            <div id="lead">
                ...
                if(!empty($kepsek)){
                    ...
                    echo '<p class="lead">Dr. Raden Nur Cahaya Sianida, S.Pd.,  M.Pd.</p>';
                }
                if(!empty($nip)){
                    echo '<p>NIP. '.$nip.'</p>';
                } else {
